...
public class JsonRPCServer {
	...
	private static RpiFuzzyIndicatorImpl fuzzyImpl;
	...
	private static class Handler extends Thread {
		...
		public Handler(Socket socket) {
			...
			dispatcher.register(new JsonHandler.DateTimeHandler(JsonRPCServer.fuzzyImpl));
		}
	...
	public static void main(String[] args) throws Exception {
		...
		JsonRPCServer.fuzzyImpl = new RpiFuzzyIndicatorImpl();
		JsonRPCServer.fuzzyImpl.startSensing();
		
		Runtime.getRuntime().addShutdownHook(new Thread() {
			public void run() {
				
				fuzzyImpl.led_all_off();
				fuzzyImpl.gpioShutdown();
