...
public class JsonRPCClient {
	...
	public static void main(String[] args) {
		...
		try {
			serverURL = new URL("http://10.10.10.125:8080");
		...
		String methodBlind = "getSensor";
		int requestID = 0;
		JSONRPC2Request request = new JSONRPC2Request(methodBlind, requestID);
		...
		try {
			...
			System.out.println("Response from ::"+response.toString());

		} catch (JSONRPC2SessionException e) {
			System.out.println("resp in catch::"+request.getID());
		System.err.println(e.getMessage());
		// handle exception...
		}
		//System.out.println("resp::"+response.getID());
